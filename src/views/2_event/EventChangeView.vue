<template>
  <div>
    <select name="" id="" @change="cityChange($event)" v-model="selectedCity">
      <!-- v-on: or @ 두개 사용가능함  -->
  ...
  data() {
    return {
      ...
      dongList: [
        ...
        { cityCode: '062', dongCode: '1', dongTitle: '제주1동' },
        { cityCode: '062', dongCode: '2', dongTitle: '제주2동' }
      ],
      selectedDongList: []
    }
  },
